import {InvalidCredentialsError} from 'src/domain/dgfip/errors/invalid-credentials.error';
import {InvalidFormatError} from 'src/domain/dgfip/errors/invalid-format.error';
