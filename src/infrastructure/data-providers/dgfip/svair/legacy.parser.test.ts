import {InvalidCredentialsError} from 'src/domain/gateway/data-providers/dgfip/errors/invalid-credentials.error';
import {InvalidFormatError} from 'src/domain/gateway/data-providers/dgfip/errors/invalid-format.error';
