import {InvalidCredentialsError} from 'src/domain/gateway/dgfip/errors/invalid-credentials.error';
import {InvalidFormatError} from 'src/domain/gateway/dgfip/errors/invalid-format.error';
