...
} = require('../../../../domain/gateway/data-providers/dgfip/errors/invalid-credentials.error.ts');
const {
  InvalidFormatError,
} = require('../../../../domain/gateway/data-providers/dgfip/errors/invalid-format.error.ts');
